...
import 'package:meal_diet_app/screens/screen_recipe.dart';
import 'package:meal_diet_app/services/service_api.dart';
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                'Protein: ${widget.mealPlan.protien.toString()} g',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w600,
                ),
